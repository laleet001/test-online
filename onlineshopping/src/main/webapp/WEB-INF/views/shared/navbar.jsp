...
<nav class="navbar navbar-default navbar-inverse">
	<div class="container">
		<a class="navbar-brand" href="${contextRoot}/home" style="height:30px; width: 80px;"></a>
		...
		<div class="navbar-collapse collapse" id="mainNavbar">
			<ul class="nav navbar-nav">
				<li id="home" class="active"><a href="${contextRoot}/home"><span class="glypicon glyphicon-earphone">Home</span></a></li>
